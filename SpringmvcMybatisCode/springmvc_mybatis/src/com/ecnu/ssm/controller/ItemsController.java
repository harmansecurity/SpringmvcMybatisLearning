...
import com.ecnu.ssm.controller.validation.ValidGroup1;
...
public class ItemsController {
    ...
    public ModelAndView queryItems(HttpServletRequest request,ItemsQueryVo itemsQueryVo) throws Exception{
    	...
    	//System.out.println("-------------------queryItems---------"+request.getParameter("id"));
...
//  }
	...
	public String editItems(HttpServletRequest request,Model model,Integer id)throws Exception {
    ...
    public String editItemsSubmit(Model model,
    	...
    	if(items_pic!=null && originalFilename!=null && originalFilename.length()>0){
    	    ...
    	    //存储图片的物理路径
    	    String pic_path = "F:\\Program Files\\eclipse-jee-luna-SR1-win32\\apache-tomcat-7.0.52\\upload\\temp\\";
    	...
    	//页面转发 通过forward进行页面转发，浏览器地址栏url不变，request可以共享。
